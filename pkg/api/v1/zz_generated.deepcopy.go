...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_JobQuota, InType: reflect.TypeOf(&JobQuota{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_JobQuotaList, InType: reflect.TypeOf(&JobQuotaList{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_JobQuotaSpec, InType: reflect.TypeOf(&JobQuotaSpec{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_JobQuotaStatus, InType: reflect.TypeOf(&JobQuotaStatus{})},
...
// DeepCopy_v1_JobQuota is an autogenerated deepcopy function.
func DeepCopy_v1_JobQuota(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*JobQuota)
		out := out.(*JobQuota)
		*out = *in
		...
		if err := DeepCopy_v1_JobQuotaSpec(&in.Spec, &out.Spec, c); err != nil {
			return err
		}
		if err := DeepCopy_v1_JobQuotaStatus(&in.Status, &out.Status, c); err != nil {
			return err
		}
		return nil
	}
...
// DeepCopy_v1_JobQuotaList is an autogenerated deepcopy function.
func DeepCopy_v1_JobQuotaList(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*JobQuotaList)
		...
		*out = *in
		...
		if in.Items != nil {
			...
			*out = make([]JobQuota, len(*in))
			for i := range *in {
				if err := DeepCopy_v1_JobQuota(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
// DeepCopy_v1_JobQuotaSpec is an autogenerated deepcopy function.
func DeepCopy_v1_JobQuotaSpec(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*JobQuotaSpec)
...
// DeepCopy_v1_JobQuotaStatus is an autogenerated deepcopy function.
func DeepCopy_v1_JobQuotaStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
