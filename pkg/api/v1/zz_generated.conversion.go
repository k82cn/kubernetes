...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_JobQuota_To_api_JobQuota,
		Convert_api_JobQuota_To_v1_JobQuota,
		Convert_v1_JobQuotaList_To_api_JobQuotaList,
		Convert_api_JobQuotaList_To_v1_JobQuotaList,
		Convert_v1_JobQuotaSpec_To_api_JobQuotaSpec,
		Convert_api_JobQuotaSpec_To_v1_JobQuotaSpec,
		Convert_v1_JobQuotaStatus_To_api_JobQuotaStatus,
		Convert_api_JobQuotaStatus_To_v1_JobQuotaStatus,
...
func autoConvert_v1_JobQuota_To_api_JobQuota(in *JobQuota, out *api.JobQuota, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1_JobQuotaSpec_To_api_JobQuotaSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1_JobQuotaStatus_To_api_JobQuotaStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_JobQuota_To_api_JobQuota is an autogenerated conversion function.
func Convert_v1_JobQuota_To_api_JobQuota(in *JobQuota, out *api.JobQuota, s conversion.Scope) error {
	return autoConvert_v1_JobQuota_To_api_JobQuota(in, out, s)
}

func autoConvert_api_JobQuota_To_v1_JobQuota(in *api.JobQuota, out *JobQuota, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_api_JobQuotaSpec_To_v1_JobQuotaSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_api_JobQuotaStatus_To_v1_JobQuotaStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_api_JobQuota_To_v1_JobQuota is an autogenerated conversion function.
func Convert_api_JobQuota_To_v1_JobQuota(in *api.JobQuota, out *JobQuota, s conversion.Scope) error {
	return autoConvert_api_JobQuota_To_v1_JobQuota(in, out, s)
}

func autoConvert_v1_JobQuotaList_To_api_JobQuotaList(in *JobQuotaList, out *api.JobQuotaList, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Items = *(*[]api.JobQuota)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1_JobQuotaList_To_api_JobQuotaList is an autogenerated conversion function.
func Convert_v1_JobQuotaList_To_api_JobQuotaList(in *JobQuotaList, out *api.JobQuotaList, s conversion.Scope) error {
	return autoConvert_v1_JobQuotaList_To_api_JobQuotaList(in, out, s)
}

func autoConvert_api_JobQuotaList_To_v1_JobQuotaList(in *api.JobQuotaList, out *JobQuotaList, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if in.Items == nil {
		out.Items = make([]JobQuota, 0)
	} else {
		out.Items = *(*[]JobQuota)(unsafe.Pointer(&in.Items))
	}
	return nil
}

// Convert_api_JobQuotaList_To_v1_JobQuotaList is an autogenerated conversion function.
func Convert_api_JobQuotaList_To_v1_JobQuotaList(in *api.JobQuotaList, out *JobQuotaList, s conversion.Scope) error {
	return autoConvert_api_JobQuotaList_To_v1_JobQuotaList(in, out, s)
}

func autoConvert_v1_JobQuotaSpec_To_api_JobQuotaSpec(in *JobQuotaSpec, out *api.JobQuotaSpec, s conversion.Scope) error {
	out.Replicas = in.Replicas
	out.RequestUnit = *(*api.ResourceList)(unsafe.Pointer(&in.RequestUnit))
	return nil
}

// Convert_v1_JobQuotaSpec_To_api_JobQuotaSpec is an autogenerated conversion function.
func Convert_v1_JobQuotaSpec_To_api_JobQuotaSpec(in *JobQuotaSpec, out *api.JobQuotaSpec, s conversion.Scope) error {
	return autoConvert_v1_JobQuotaSpec_To_api_JobQuotaSpec(in, out, s)
}

func autoConvert_api_JobQuotaSpec_To_v1_JobQuotaSpec(in *api.JobQuotaSpec, out *JobQuotaSpec, s conversion.Scope) error {
	out.Replicas = in.Replicas
	out.RequestUnit = *(*ResourceList)(unsafe.Pointer(&in.RequestUnit))
	return nil
}

// Convert_api_JobQuotaSpec_To_v1_JobQuotaSpec is an autogenerated conversion function.
func Convert_api_JobQuotaSpec_To_v1_JobQuotaSpec(in *api.JobQuotaSpec, out *JobQuotaSpec, s conversion.Scope) error {
	return autoConvert_api_JobQuotaSpec_To_v1_JobQuotaSpec(in, out, s)
}

func autoConvert_v1_JobQuotaStatus_To_api_JobQuotaStatus(in *JobQuotaStatus, out *api.JobQuotaStatus, s conversion.Scope) error {
	out.Used = *(*api.ResourceList)(unsafe.Pointer(&in.Used))
	out.Allocated = *(*api.ResourceList)(unsafe.Pointer(&in.Allocated))
	out.Reclaiming = *(*api.ResourceList)(unsafe.Pointer(&in.Reclaiming))
	return nil
}

// Convert_v1_JobQuotaStatus_To_api_JobQuotaStatus is an autogenerated conversion function.
func Convert_v1_JobQuotaStatus_To_api_JobQuotaStatus(in *JobQuotaStatus, out *api.JobQuotaStatus, s conversion.Scope) error {
	return autoConvert_v1_JobQuotaStatus_To_api_JobQuotaStatus(in, out, s)
}

func autoConvert_api_JobQuotaStatus_To_v1_JobQuotaStatus(in *api.JobQuotaStatus, out *JobQuotaStatus, s conversion.Scope) error {
	out.Used = *(*ResourceList)(unsafe.Pointer(&in.Used))
	out.Allocated = *(*ResourceList)(unsafe.Pointer(&in.Allocated))
	out.Reclaiming = *(*ResourceList)(unsafe.Pointer(&in.Reclaiming))
	return nil
}

// Convert_api_JobQuotaStatus_To_v1_JobQuotaStatus is an autogenerated conversion function.
func Convert_api_JobQuotaStatus_To_v1_JobQuotaStatus(in *api.JobQuotaStatus, out *JobQuotaStatus, s conversion.Scope) error {
	return autoConvert_api_JobQuotaStatus_To_v1_JobQuotaStatus(in, out, s)
}
