...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_JobQuota, InType: reflect.TypeOf(&JobQuota{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_JobQuotaList, InType: reflect.TypeOf(&JobQuotaList{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_JobQuotaSpec, InType: reflect.TypeOf(&JobQuotaSpec{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_JobQuotaStatus, InType: reflect.TypeOf(&JobQuotaStatus{})},
...
// DeepCopy_api_JobQuota is an autogenerated deepcopy function.
func DeepCopy_api_JobQuota(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*JobQuota)
		out := out.(*JobQuota)
		*out = *in
		...
		if err := DeepCopy_api_JobQuotaSpec(&in.Spec, &out.Spec, c); err != nil {
			return err
		}
		if err := DeepCopy_api_JobQuotaStatus(&in.Status, &out.Status, c); err != nil {
			return err
		}
		return nil
	}
...
// DeepCopy_api_JobQuotaList is an autogenerated deepcopy function.
func DeepCopy_api_JobQuotaList(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*JobQuotaList)
		out := out.(*JobQuotaList)
		*out = *in
		if newVal, err := c.DeepCopy(&in.ObjectMeta); err != nil {
			return err
		} else {
		...
		if in.Items != nil {
			in, out := &in.Items, &out.Items
			*out = make([]JobQuota, len(*in))
			for i := range *in {
				if err := DeepCopy_api_JobQuota(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
// DeepCopy_api_JobQuotaSpec is an autogenerated deepcopy function.
func DeepCopy_api_JobQuotaSpec(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*JobQuotaSpec)
		out := out.(*JobQuotaSpec)
		*out = *in
		if in.RequestUnit != nil {
			in, out := &in.RequestUnit, &out.RequestUnit
...
// DeepCopy_api_JobQuotaStatus is an autogenerated deepcopy function.
func DeepCopy_api_JobQuotaStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*JobQuotaStatus)
		out := out.(*JobQuotaStatus)
		*out = *in
		if in.Used != nil {
		...
		if in.Reclaiming != nil {
			in, out := &in.Reclaiming, &out.Reclaiming
			*out = make(ResourceList)
			for key, val := range *in {
				(*out)[key] = val.DeepCopy()
			}
